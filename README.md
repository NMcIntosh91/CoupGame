...
are. I have the basic structure of the game down but it's not really playable as of yet. The CPU isn't a smart opponent. It just makes random moves. I almost aim
...
Coup is a very fun card game from between 2 - 6 players. It's best played with 3 - 6 players.
Each player is given 2 cards from a shuffled deck. Players can always look at their own cards but must keep them face down in front of them. 
...
The end of the game is to be the last person standing. A player's facedown cards represent their roles as well as their lives. Each character printed on their face down cards represents a character role and specific abilities. Each time a player loses a role they must reveal one of their roles
...
of the game. Players take turns doing one action each. Character actions can only be performed when with a player claiming to have a certain role. They may be 
...
fails, the action succeeds after the challenge. The loser of the challenge loses a character role.
 
Character actions
------------------
Duke - Earns 3 Coins, Blocks Foreign Aid
Captain - Steals 2 coins, Blocking Stealing
